...
const Receipt = ({ receiptInfo }) => {
  ...
  useEffect(() => {
    setTaxesAndFees(
      +receiptInfo.total * 0.0975 + (receiptInfo.isDelivery ? 3 : 0)
    );
  ...
  return (
    <div className="px-7 py-7 divide-y-[.1rem] w-full divide-gray-200 overflow-y-scroll overscroll-y-contain container-snap">
      <div className="pb-4">
      ...
      <div>
        ...
        <div className="py-2 font-semibold text-lg">Order Details</div>
