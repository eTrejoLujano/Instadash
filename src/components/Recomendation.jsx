...
const Recomendation = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="top-[12rem] pr-[60rem] justify-center flex mx-auto">
      ...
      <div className="flex flex-row justify-center space-x-3 space-y-3">
        {/* <div>
          <div className="top-[2.5rem] right-[31rem] relative">
            <h2 className="font-semibold relative text-2xl truncate">
              National Favorites
            </h2>
          </div>
        </div> */}
